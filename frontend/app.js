...
const TRIVIA_FACTS_BY_KEY = {
  pvp: [
    {
      title: '连五取胜',
      text: '标准五子棋中，横、竖、斜任一方向先连成五子的玩家获胜。'
    },
    {
      title: '落子不移',
      text: '五子棋的棋子落下后通常不再移动，因此也很适合用纸笔画格来玩。'
    },
    {
      title: '黑先白后',
      text: '常见对局由黑子先行，白子随后落子，双方轮流在空位上放下一枚棋子。'
    }
  ],
  easy: [
    {
      title: '活三',
      text: '活三指两端都有延伸空间的三子形，继续发展后可能形成更强的威胁。'
    },
    {
      title: '冲四',
      text: '冲四是已经连成四子、但通常只有一个取胜点的棋形，对手往往必须立刻防守。'
    },
    {
      title: '中心开局',
      text: '在 15 路棋盘上，中心区域向四个方向都有较大空间，因此常被用作开局落点。'
    }
  ],
  medium: [
    {
      title: '眠三',
      text: '眠三通常指一端受限的三子形，威胁弱于活三，但仍可能参与后续组合进攻。'
    },
    {
      title: '活四',
      text: '活四两端都有取胜点，一旦形成，防守方通常已经很难同时挡住。'
    },
    {
      title: '断点',
      text: '两段棋子之间的空位常被称为断点，补上断点可能把分散的棋形连成威胁。'
    }
  ],
  hard: [
    {
      title: '双三',
      text: '双三指一步棋同时形成两个活三。许多连珠规则会限制黑方走出这类棋形。'
    },
    {
      title: '双四',
      text: '双四指一步棋同时形成两个四子威胁，防守方往往无法同时堵住两个方向。'
    },
    {
      title: '先手优势',
      text: '五子棋长期存在先手优势讨论，限制黑方禁手和使用交换规则都与此有关。'
    }
  ],
  expert: [
    {
      title: '禁手',
      text: '连珠规则中，黑方通常受到三三、四四和长连等禁手限制，用来平衡先手优势。'
    },
    {
      title: '长连',
      text: '长连指同色棋子连续超过五枚。在部分规则中，黑方长连不算胜，甚至会被判为禁手。'
    },
    {
      title: '连珠',
      text: '连珠是五子棋发展出的竞技规则体系，重点在于通过规则限制来削弱黑方先行优势。'
    }
  ],
  joseki: [
    {
      title: '定式',
      text: '定式记录常见开局结构中的成熟应对方式，主要用于处理前几手的布局。'
    },
    {
      title: '开局研究',
      text: '五子棋和连珠都有系统化的开局研究，许多开局形状有固定名称。'
    },
    {
      title: '天元',
      text: '棋盘正中央的位置常被称为天元，许多开局都会围绕中心区域展开。'
    }
  ],
  lan: [
    {
      title: '棋盘规格',
      text: '常见五子棋棋盘为 15 路，也就是横竖各 15 条线，共 225 个交叉点。'
    },
    {
      title: '交换规则',
      text: '一些比赛规则允许开局后交换执子方，用来缓解黑方先行带来的优势。'
    },
    {
      title: '对局记录',
      text: '正式对局常会记录每一步落点，便于赛后复盘、研究开局和分析关键手。'
    }
  ]
};
